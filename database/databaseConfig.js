...
const patientSchema = new mongoose.Schema({
    ...
    reasonForVisit: { type: String, }, // Primary complaint
    ...
    imagingResults: { type: String }, // e.g., X-rays, MRIs
    prescribedMedications: { type: String },
    ongoingTreatments: { type: String }, // e.g., physiotherapy, chemotherapy
